...
Camera::Camera()
{
    ...
    g_bExit = false;
    g_nPayloadSize = 0;
    pDataForRGB = (unsigned char*)malloc(2448 * 2048 * 4 + 2048);
...
//打开相机
void Camera::start_cam(unsigned int nIndex)
{
...
void Camera::get_pic(cv::Mat* srcimg)
{
    ...
    *srcimg = Mat(stOutFrame.stFrameInfo.nHeight, stOutFrame.stFrameInfo.nWidth, CV_8UC1, stOutFrame.pBufAddr);

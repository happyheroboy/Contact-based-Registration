...
for i = 1:25
    fileName0 = ['C:\Users\Lenovo\Desktop\MJ_re-exp\Marker-4\9-18 bd\dya_\0\',int2str(i),'.txt'];
    fileName1 = ['C:\Users\Lenovo\Desktop\MJ_re-exp\Marker-4\9-18 bd\dya_\1\',int2str(i),'.txt'];
